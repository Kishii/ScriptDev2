...
{
    pPlayer->ADD_GOSSIP_ITEM(0, "Voulez vous renommer votre personnage ?", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
...
bool GossipSelect_custom_npc_renamecharacter(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    ...
    {
		pCreature->MonsterWhisper("Votre pseudonyme prendra effet à votre prochaine connexion.", pPlayer->GetGUID());
